...
8 位使用者，5 趟不同組合的旅行：
  Trip 1: 東京自由行    - 示範使用者 A、示範使用者 B、示範使用者 C、示範使用者 D（4人）
  Trip 2: 首爾追星之旅  - 示範使用者 E、示範使用者 F、示範使用者 G、示範使用者 H（4人）
  Trip 3: 清邁探索之旅  - 示範使用者 A、示範使用者 C、示範使用者 E、示範使用者 F（4人）
  Trip 4: 沖繩海島行    - 示範使用者 B、示範使用者 D、示範使用者 G、示範使用者 H（4人）
...
TRIP3_TXN = [
    # members local: 0=示範使用者 A, 1=示範使用者 C, 2=示範使用者 E, 3=示範使用者 F
...
TRIP4_TXN = [
    # members local: 0=示範使用者 B, 1=示範使用者 D, 2=示範使用者 G, 3=示範使用者 H
